...
<sub>Дашборд стрімить атаки в реальному часі. Згенеруй цей вигляд кнопкою **Demo** (синтетичні атаки, без реальних даних).</sub>
...
- **Демо одним кліком** — кнопка `Demo` інжектить синтетичні атаки з усього світу (фейкові MAC, справжні GeoIP-прапорці), щоб показати дашборд / записати GIF без розкриття реальних даних. Вимикається `DEMO_ENDPOINT_ENABLE 0`.
